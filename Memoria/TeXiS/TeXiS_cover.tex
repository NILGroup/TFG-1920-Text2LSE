...
\def\escalaImagenPortadaVal{0.6}
...
\textbf{Traductor de Texto a Lengua de Signos}}
\begin{center}
\rule{\longTitulo}{.5mm}\\
\vskip 0.6cm
...
\begin{center}
  {\Large \textbf{Text2LSE: Text to Spanish Sign Language Translator}}
\end{center}
...
\textit{\institucionVal}\\[1em]
\textit{\fechaPublicacionVal}
