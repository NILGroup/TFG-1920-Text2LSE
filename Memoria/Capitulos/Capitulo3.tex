...
Una vez analizada la posibilidad de usar una u otra se ha llegado a la conclusión de que Spacy es la herramienta adecuada, ya que proporciona un análisis rápido y bastante preciso en Español lo cual es de gran importancia en este proyecto y además es muy sencilla de aprender a manejar gracias a su manual de uso. Que la herramienta ofrezca un análisis bastante bueno en castellano es el motivo principal del por qué hemos decidido utilizar esta herramienta en vez de otra, aunque tambíen es importante la relación que hay entre la rapidez de procesamiento y facilidad de uso con respecto a otras herramientas de PLN.
