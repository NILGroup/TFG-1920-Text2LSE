...
Se ha utilizado un servidor NGINX para alojar una aplicación web cuya finalidad es mostrar la funcionalidad de los diferentes microservicios implementados en el proyecto. (ref a micro servicios)
