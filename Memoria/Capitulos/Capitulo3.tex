...
Spacy mediante la clase Tokenizer es capaz de dividir el texto de entrada en palabras aportando la siguiente información de cada palabra. 
...
Una vez analizadas en detalle cada una de las herramientas presentadas en esta sección, se llega a la conclusión de que Spacy es la herramienta adecuada, ya que proporciona un análisis rápido y bastante preciso en Español lo cual es de gran importancia en este proyecto ya que necesitamos traducir textos en español. Aademás es muy sencilla de aprender a manejar gracias a tener un manual de uso claro y sencillo con gran cantidad de ejemplos.
