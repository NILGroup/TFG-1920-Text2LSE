...
%-------------------------------------------------------------------
Para que una máquina sea capaz de entender y procesar el lenguaje natural, es necesario analizar la estructura de dicho lenguaje, y gracias al PLN podemos realizar distintos análisis como:


\begin{itemize}
	
	\item\textbf{Análisis Fonológico:} se encarga de analizar cómo las palabras se relacionan con los sonidos que representan.
	...
	\item\textbf{Análisis Semántico:} estudio del significado de las expresiones del lenguaje y de cómo los significados de las palabras se unen para dar sentido a una oración. Un ejemplo sería: \textit{``Pedro habla la Lengua de Signos''.}
	
	
	\item\textbf{Análisis Pragmático:} trata de cómo las oraciones se usan en distintas situaciones y de cómo el uso afecta al significado de las oraciones.
