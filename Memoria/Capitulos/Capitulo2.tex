...
%-------------------------------------------------------------------
A continuación, se explica el conocimiento básico de estas normas en lo referente a la gramática, fonología, sintaxis y morfología.
...
\begin{itemize}
	...
	\item \textbf{Movimiento} de las manos al realizar un signo. Puede ser giratorio, vaivén o quebrado, entre otros. Podemos observar en que consisten algunos de estos movimientos en la Figura~\ref {fig: imgLSEMovimientos}
...
Las oraciones en la LSE no se estructuran igual que en castellano. La LSE es una lengua analítica, es decir, la estructura de las oraciones es muy simple, tendiendo a simplificar las frases para comunicar la información de la manera más concisa posible, al igual que lenguas como japonés o alemán.\\

La estructura básica de las oraciones se compone de sujeto-objeto-verbo, aunque existen excepciones. Por ejemplo, la oración \textit{``Él come patatas''} en LSE se traduciría como \textit{``Él patatas comer''}. Según se van incorporando elementos a las oraciones, la estructura se va volviendo más compleja siguiendo un orden temporal, es decir, las acciones se nombran en el orden en el que suceden. Por ejemplo, la oración \textit{``Después de comer me fui a dormir''}, se traduciría a LSE como \textit{``Yo comer fin dormir ir''}, indicando que primero se realizó la acción de comer y después la acción de irse a dormir.
