...
Hemos enfocado la fase de evaluación en la traducción a LSE, probando diversas oraciones  en castellano y verificando la traducción que nos proporciona la aplicación con ayuda de un experto en LSE, nuestro tutor Antonio. Se ha verificado tanto la salida en formato imagen como la salida en formato vídeo, obteniendo como resultado que ambas traducciones son similares.\\
...
Como podemos observar en estos resultados, el corpus de frases sencillas cuenta con un porcentaje de frases entendibles bastante más alto (76\%) que el resto de corpus, cuyos porcentajes rondan el 20 o el 30\%. Esto es debido a que en estos últimos la complejidad y riqueza de vocabulario de las frases es más elevada, produciendo así una serie de errores que analizaremos a continuación.
...
Los resultados obtenidos han sido muy beneficiosos, ya que nos permiten ver con claridad en qué aspectos se puede mejorar la aplicación desarrollada.(COMPLETAR)
...
\begin{table}[htbp]
	\begin{center}
		\begin{tabular}{|c|c|c|}
			...
			\hline \hline
			Género y número 							& 1 / 109 	&  \%  \\ \hline
			Cambio de significado  						& 2 / 109 	&  \%  \\ \hline
			Preposiciones  								& 7 / 109 	&  \%  \\ \hline
			Negación	  								& 3 / 109 	&  \%  \\ \hline
			Particularidad LSE  						& 25 / 109 	&  \%  \\ \hline
			Estructuras compuestas	  					& 42 / 109 	&  \%  \\ \hline
			Misma palabra con distinto significado  	& 1 / 109 	&  \%  \\ \hline
			Fallo del analizador	  					& 19 / 109 	&  \%  \\ \hline
