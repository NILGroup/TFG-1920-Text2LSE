...
Existen diversas modalidades de metodologías ágiles, algunas de las más conocidas son Scrum o Programación Extrema (XP). Para el desarrollo de este proyecto se ha optado por la utilización de Kanban, que se explica en detalle en la sección 4.2).
