...
Existen diversas metodologías ágiles, algunas de las más conocidas son Scrum o Programación Extrema (XP). Para el desarrollo de este proyecto se ha obtado por la utilización de Kanban, que se explica en detalle a continuación (sección 4.2).
