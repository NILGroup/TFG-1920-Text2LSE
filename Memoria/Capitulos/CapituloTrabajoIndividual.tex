...
La redacción de la memoria ha ido dividiéndose entre los tres integrantes del equipo. Cada miembro se encargaba de redactar su parte, además de incorporar las correcciones de los tutores. En el capítulo 2 me encargué de redactar el apartado de \textit{las aplicaciones de traducción de texto a LSE} y \textit{el Procesamiento de Lenguaje Natural}, en el capítulo 3 mi aportación ha sido la redacción de los \textit{Servicios Web} y en el capítulo 4 he redactado el aparatado de \textit{control de versiones}. De cara a la parte final de la memoria he ayudado a redactar el capitulo 5 junto con mis compañeros, escribiendo la sección del \textit{Servicio web para Traducción de texto en castellano a texto en LSE} y el capítulo 8 con la ayuda de Alex y Sara.\\

En cuanto al desarrollo de la aplicación, al principio se hizo un trabajo de investigación de manera individual para aprender como funcionan las herramientas de las cuales se iba a hacer uso en el proyecto, como las API, los Servicios Web, Spacy y el control de versiones con Github. Una vez hecho el trabajo de investigación mi aportación ha sido crear reglas de PLN y crear algunos servicios como el de devolver una imagen además de otros, junto con mis compañeros. También me he encargado de la salida en caso de error de la traducción, sustituyendo el modal de error por una imagen o vídeo indicando que no existe ese recurso en nuestra librería.\\

Para el desarrollo de la Web responsive he participado manera conjunta y activa con mis compañeros en el diseño de la aplicación para que sea totalmente adapatable a todos los dispositivos.
