...
A continuación, comenzamos a crear una primera base de la aplicación. Lo primero fue realizar la preparación del entorno local en Debian 10, utilizando Nginx para alojar la aplicación web, y Flask para ejecutar la API, preparando el modo debug para el posterior proceso de desarrollo de código. Construimos una web básica, en la cual podíamos escribir un texto y enviarlo a la API a través de JavaScript, mediante jQuery y Ajax, y una primera estructura de la API REST en Python. En este apartado me encargue junto con mi compañero Alejandro del desarrollo de una funcionalidad javascript capaz de lanzar una petición a la API con el texto y que esta nos devolviese un vídeo mp4. Más adelante decidimos cambiar las llamadas AJAX por llamadas Fetch. Respecto a los servicios web, me dediqué de estructurar la función que devuelve un vídeo con varios signos y de desarrollar las llamadas a las funciones que devuelven diferente tipo de información en formato JSON. Respecto a PLN, en un principio me centré en desarrollar un algoritmo recursivo que recorriese un árbol de dependencias desde el verbo a partir de una frase, complementándolo con el tratamiento de preposiciones y artículos colocando las palabras en orden de LSE.\\

Respecto a la parte técnica de la memoria, me encargué de desarrollar los apartados de Google Colaboratory y la estructura de GitHub dentro de herramientas utilizadas, y de metodologías como Trello y Reuniones. \\
