...
Respecto a la memoria, me encargué de desarrollar los apartados de Google Colaboratory y la estructura de GitHub dentro de herramientas utilizadas, y de metodologías como Trello y Reuniones. En el apartado de Text2LSE me centré en desarrollar la introducción, arquitectura y servicios web de traducción a video, con sus respectivos diagramas de flujo.\\
...
Junto con el trabajo técnico, también participé en la redacción y corrección  de la memoria. Los tres compañeros desarrollamos conjuntamente el capítulo 1 y 2, y posteriormente me encargué de la corrección del capítulo 1 y parte del capítulo 2 según fueron llegando las correcciones de nuestros tutores. Además, desarrollé el apartado de Flask del capítulo 3 y metodologías de trabajo en el capítulo 4. En cuanto al capítulo 5, escribí la sección Front-End, la introducción de la sección Back-End y los servicios de traducción LSE en imágenes.\\
