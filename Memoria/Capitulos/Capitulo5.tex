...
\subsection{Servicio web para obtener el video de un signo en LSE de una determinada palabra}
...
\subsection{Servicio web para Traducción de texto a vídeo en LSE}
