...
Se ha utilizado un reverse proxy para poder acceder tanto a la página web como a los servicios web en un mismo servidor. Se han especificado una serie de rutas para diferenciar qué llamadas de usuario redireccionar a la página web y cuáles a los servicios web. Esta estructura se puede observar en la Figura 5.X.
...
\begin{itemize}
	...
	\item \textbf{Traducción a vídeo:} en esta sección el usuario podrá introducir el texto en castellano que desee traducir, y tras pulsar el botón ``traducir'' se podrá visualizar por pantalla un vídeo en el que se podrá ver a un intérprete de ARASAAC realizando los signos LSE correspondientes.
