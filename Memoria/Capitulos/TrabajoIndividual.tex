...
En la fase posterior, me encargué de corregir mis apartados correspondientes de la memoria, y de desarrollar los nuevos apartados de Python y metodologías utilizadas como Trello y Reuniones. También me encargué de estructurar la función de la API que devuelve un video con varios signos y de desarrollar las llamadas a las funciones que devuelven diferente tipo de información en Json. Respecto a PLN, en un principio me centré en desarrollar un algoritmo que recorra un árbol de dependencias desde el verbo a partir de una frase.\\
...
Junto con el trabajo técnico, también participé en la redacción y corrección  de la memoria, en la que trabajamos los tres compañeros conjuntamente. Me encargué de la corrección del capítulo 1 y parte del capítulo 2. Además, desarrollé los apartados de Flask, metodologías agiles y kanban.
