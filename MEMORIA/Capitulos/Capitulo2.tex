...
TextSign\footnote{Web oficial de TextSign \url{http://textosign.es/}} es una herramienta software que funciona en páginas web, asistentes virtuales y dispositivos móviles que traduce en tiempo real un texto a la Lengua de Signos Española mediante un intérprete visual llamado Maya. Se trata de herramienta de pago y es utilizada hoy en día por La caixa, Adif, Inturjoven y otras diversas entidades.
...
Los Servicios Web SOAP\footnote{Web \url{https://www.ibm.com/support/knowledgecenter/es/SSMKHH_9.0.0/com.ibm.etools.mft.doc/ac55710_.html}} son un tipo de servicios web cuyo propósito es que las aplicaciones implementadas en diferentes plataformas y lenguajes de programación sean capaces de intercambiar datos de una forma más sencilla. \\
